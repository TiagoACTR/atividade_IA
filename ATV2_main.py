...
print(
    "OLá, estou aqui para falar sobre a Universidade Jardins de Anita-UFC. \
              o que você quer saber sobre a universidade?"
)
...
while flg:
    # Q/A
    print("\n\n")
    asked_question = str(input("what is in your mind \ o que você quer saber?: ")).lower()
    ...
    if (
        ...
        "lugar da ufc" in asked_question
        or "lugar" in asked_question
    ):
        # Q: Lugar da universidade
        question = "Lugar"
        query = "lugar(" + question + ")."
        answers = ask_question(query)
        say_answers("", "", question, answers)
        ...
        # Q Quantos cursos há na universidade?
        question = "Quantidade_de_cursos"
        query = "quantidade_de_cursos('Jardins de Anita-UFC', " + question + ")."
        answers = ask_question(query)
        say_answers(
            "Há ", "cursos no campus Jardins de Anita-UFC", question, answers
        )
        ...
        "nome dos curso" in asked_question
        or "quais cursos" in asked_question
    ):
        # Q Nome dos Cursos
        question = "Cursos"
        query = "cursos('Jardins de Anita-UFC', " + question + ")."
        answers = ask_question(query)
        say_answers("Existem 3 cursos na universidade Jardins de Anita-UFC, eles são, ","", question, answers,
        )
